...
import { ArrowLeft, Home, Building2, Check, AlertCircle, Upload, X, ImageIcon, Plus, Users } from "lucide-react"
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-white">Crear Nueva Propiedad</h1>
                <p className="text-white/60 text-sm">Registra una nueva propiedad en el sistema</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/owners">
